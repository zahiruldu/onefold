...
const disposersByNode = new WeakMap<Node, Set<Disposer>>();
...
function runDisposersForSubtree(node: Node): void {
 ...
 */
export function disposeOnRemove(node: Node, dispose: Disposer): void {
  ensureObserver();
